...
const SHEET_HEADER_CLASS = "flex flex-col gap-1.5 p-4"
const SHEET_FOOTER_CLASS = "mt-auto flex flex-col gap-2 p-4"
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          "flex flex-col shadow-lg transition ease-in-out",
