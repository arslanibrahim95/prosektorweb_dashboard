...
export const users = {
    ...
    ownerB: {
        ...
        email: 'owner-b@prosektorweb.com',
        name: 'Owner B',
...
export const jobApplications = {
    appA1: {
        ...
        email: 'applicant@prosektorweb.com',
        phone: '5559876543',
